...
stat_weights = c(Similarity=1.0, CellNumber=0.66, GWAS=0.66, DENumber=0.33, GONumber=0.33, EPEnrichment=0.33)
...
plot_grid(
  ggdraw(gg_ranks + theme(legend.position="none", plot.margin=margin(r=10, t=10)) +
         draw_plot(gg_stat_weights + theme_nothing(), 
                   x=length(type_order) - 0.25, y=-5.9, height=6.25, width=1, vjust=-1) +
